          ...
          <div class="col-lg-8 mb-4 mb-lg-0">
            <div class="d-flex align-items-center">
              <div class="border p-2 d-inline-block mr-3 rounded">
                <img src="<?= base_url('public/assets/images/job_logo_5.jpg')?>" alt="Image">
              </div>
              <div>
        ...
        <ul class="job-listings mb-5">
          <li class="job-listing d-block d-sm-flex pb-3 pb-sm-0 align-items-center">
            ...
            <div class="job-listing-logo">
              <img src="<?= base_url('public/assets/images/job_logo_1.jpg')?>" alt="Image" class="img-fluid">
            </div>
          ...
          <li class="job-listing d-block d-sm-flex pb-3 pb-sm-0 align-items-center">
            <a href="job-single.html"></a>
            <div class="job-listing-logo">
              <img src="<?= base_url('public/assets/images/job_logo_2.jpg')?>" alt="Image" class="img-fluid">
            </div>
          ...
          <li class="job-listing d-block d-sm-flex pb-3 pb-sm-0 align-items-center">
            <a href="job-single.html"></a>
            <div class="job-listing-logo">
              <img src="<?= base_url('public/assets/images/job_logo_3.jpg')?>" alt="Image" class="img-fluid">
            </div>
          ...
          <li class="job-listing d-block d-sm-flex pb-3 pb-sm-0 align-items-center">
            <a href="job-single.html"></a>
            <div class="job-listing-logo">
              <img src="<?= base_url('public/assets/images/job_logo_4.jpg')?>"alt="Image" class="img-fluid">
            </div>
          ...
          <li class="job-listing d-block d-sm-flex pb-3 pb-sm-0 align-items-center">
            <a href="job-single.html"></a>
            <div class="job-listing-logo">
              <img src="<?= base_url('public/assets/images/job_logo_5.jpg')?>" alt="Image" class="img-fluid">
            </div>
